...
while run:
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            if event.button == 1:
                if active_box is not None:
                    # Find the line where the gate was dropped
                    line_collision = None
    ...
    X_surface=font1.render(X, True, (255, 255, 255))
    ...
    ang_surface=font1.render(ang, True, (255, 255, 255))
    ...
    dist_surface=font1.render(dist, True, (255, 255, 255))
